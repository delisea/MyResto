...
idResto1=$(curl --silent POST "http://localhost:8080/javaee7-angular/resources/restaurants" -H "accept: application/json" -H "Content-Type: application/json" -d "{ \"id\": 0, \"name\": \"Chez Le Pèr'Gras\", \"description\": \"Cette table propose un menu régional gastronomique dans un cadre élégant ou en terrasse avec vue sur la ville.\", \"address\": \"90 Chemin de la Bastille, 38000 Grenoble\", \"url_img\": \"http://www.pergras.com/uploads/2016/08/PG_contact-footer.jpg\", \"tel_number\": \"04 76 42 09 47\", \"email\": \"pergras.fr\", \"latitude\": 45.201539, \"longitude\": 5.725881}")
